...
<HTMLBlock>{`
<button class="add-article-btn" onclick="window.location.href='https://dash.readme.com/to/henry-howler-group?redirect=%2Fdocs%2Fv1.0_new-stuff%2Fupdate%2Fdocs%2Fhow-to-add-articles'">
