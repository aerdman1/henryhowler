...
After each rapid, we frequently observed empty boats drifting solo, indicating a capsize. This was our cue to spring into action. We would grab the loose paddle, then pull alongside the unmanned kayak. Peter would then leap in, steer it back to its paddler—typically waiting on the shore—and hop back into our boat. We began to feel like river lifeguards. Eventually, we intentionally started to hang back, going last through the rapids to spot stragglers and offer assistance when needed.
